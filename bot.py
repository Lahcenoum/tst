...
JOIN_BONUS = 0
REFERRAL_BONUS = 2
RENEW_SSH_COST = 2  # عدد النقاط لتجديد حساب SSH
...
(ADD_ITEM_NAME, ADD_ITEM_POINTS, ADD_ITEM_LINK) = range(14, 17)
...
TEXTS = {
    'ar': {
        ...
        "points": "نقاط",
        "renew_ssh_button": "♻️ تجديد حساب SSH",
        "no_ssh_to_renew": "ℹ️ لا يوجد حساب SSH لتجديده.",
        "renew_cost_info": "تكلفة تجديد الحساب هي {cost} نقطة.",
        "renew_success": "✅ تم تجديد حسابك SSH بنجاح حتى: {expiry}.\nتم خصم {cost} نقطة.",

        "shop_button": "🛒 المتجر",
        "shop_empty": "ℹ️ لا توجد سلع حالياً في المتجر.",
        "shop_header": "اختر سلعة من المتجر:",
        "shop_bought": "✅ تمت عملية الشراء بنجاح!\nالرابط الخاص بك:\n{link}",
        "shop_not_enough_points": "⚠️ رصيدك لا يكفي لشراء هذه السلعة. السعر {cost} نقطة.",

        "admin_manage_shop_button": "🛒 إدارة المتجر",
        "admin_add_item_button": "➕ إضافة سلعة",
        "admin_remove_item_button": "➖ إزالة سلعة",
        "admin_add_item_name_prompt": "أرسل اسم السلعة:",
        "admin_add_item_points_prompt": "أرسل عدد النقاط المطلوبة لهذه السلعة:",
        "admin_add_item_link_prompt": "أرسل الرابط الذي سيستلمه المستخدم بعد الشراء:",
        "admin_item_added_success": "✅ تم إضافة السلعة بنجاح.",
        "admin_no_items": "ℹ️ لا توجد سلع حالياً.",
        "admin_remove_item_prompt": "اختر السلعة التي تريد حذفها:",
        "admin_item_removed_success": "🗑️ تم حذف السلعة بنجاح.",
    },
    'en': {
